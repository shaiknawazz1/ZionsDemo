#Code converted on 2023-04-26 15:37:16
import os
...
dbutils.widgets.text(name = 'ps_BANCS_BRL', defaultValue = '')
ps_BANCS_BRL = dbutils.widgets.get("ps_BANCS_BRL")
...
#ps_BANCS_BRL.DS_BRL_SRC_SCHEMA#.acct_address_link
WHERE
BRL_RECORD_DT=TO_DATE('#ps_BANCS_BRL.BRL_RECORD_DT#','yyyymmdd')"""
...
#ps_BANCS_BRL.DS_BRL_SRC_SCHEMA#.BUDGET_LINE_ITEM_MASTER
WHERE
BRL_RECORD_DT=TO_DATE('#ps_BANCS_BRL.BRL_RECORD_DT#','yyyymmdd')"""
...
BRL_RECORD_DT
FROM
#ps_BANCS_BRL.DS_BRL_SRC_SCHEMA#.ARRANGEMENT_PROD_LINK
WHERE
BRL_RECORD_DT=TO_DATE('#ps_BANCS_BRL.BRL_RECORD_DT#','yyyymmdd')"""
...
#ps_BANCS_BRL.DS_BRL_SRC_SCHEMA#.ARRANGEMENT_MEMBER_MIRROR
WHERE
BRL_RECORD_DT=TO_DATE('#ps_BANCS_BRL.BRL_RECORD_DT#','yyyymmdd')"""
...
#ps_BANCS_BRL.DS_BRL_SRC_SCHEMA#.ARRANGEMENT_LINK_ENQUIRY
WHERE
BRL_RECORD_DT=TO_DATE('#ps_BANCS_BRL.BRL_RECORD_DT#','yyyymmdd')"""
...
#ps_BANCS_BRL.DS_BRL_SRC_SCHEMA#.ARRANGEMENT_MEMBER_PROD_LINK
WHERE
BRL_RECORD_DT=TO_DATE('#ps_BANCS_BRL.BRL_RECORD_DT#','yyyymmdd')"""
...
#ps_BANCS_BRL.DS_BRL_SRC_SCHEMA#.BUDGET_SUMMARY_MASTER
WHERE
BRL_RECORD_DT=TO_DATE('#ps_BANCS_BRL.BRL_RECORD_DT#','yyyymmdd')"""
...
BRL_RECORD_DT
FROM
#ps_BANCS_BRL.DS_BRL_SRC_SCHEMA#.arrangement_acct_link
WHERE
BRL_RECORD_DT=TO_DATE('#ps_BANCS_BRL.BRL_RECORD_DT#','yyyymmdd')"""
...
#ps_BANCS_BRL.DS_BRL_SRC_SCHEMA#.ARRANGEMENT_MEMBER_LINK
WHERE
BRL_RECORD_DT=TO_DATE('#ps_BANCS_BRL.BRL_RECORD_DT#','yyyymmdd')"""
...
#ps_BANCS_BRL.DS_BRL_SRC_SCHEMA#.ACCT_FACILITY_REL_DTLS
WHERE
BRL_RECORD_DT=TO_DATE('#ps_BANCS_BRL.BRL_RECORD_DT#','yyyymmdd')"""
...
BRL_RECORD_DT
FROM
#ps_BANCS_BRL.DS_BRL_SRC_SCHEMA#.ARRANGEMENT_SETUP_MASTER
WHERE
BRL_RECORD_DT=TO_DATE('#ps_BANCS_BRL.BRL_RECORD_DT#','yyyymmdd')"""
...
spark.sql('drop table if exists BUDGET_SUMMARY_MASTER_aud')
SA_CUSTOMER_DS.write.saveAsTable(BUDGET_SUMMARY_MASTER_aud)
...
spark.sql('drop table if exists BUDGET_LINE_ITEM_MASTER_aud')
SA_CUSTOMER_DS.write.saveAsTable(BUDGET_LINE_ITEM_MASTER_aud)
...
spark.sql('drop table if exists ARRANGEMENT_MEMBER_MIRROR_aud')
SA_CUSTOMER_DS.write.saveAsTable(ARRANGEMENT_MEMBER_MIRROR_aud)
...
spark.sql('drop table if exists SEQ_ARRANGEMENT_MEMBER_PROD_LINK')
SA_CUSTOMER_DS.write.saveAsTable(SEQ_ARRANGEMENT_MEMBER_PROD_LINK)
...
LINK_OUT_CONV4 = DATA_IN_CONV5.select(
	...
	DATA_IN.COMMITMENT_INTEREST_RECEIVABLE.alias('COMMITMENT_INTEREST_RECEIVABLE'),
...
spark.sql('drop table if exists SEQ_ACCT_ADDRESS_LINK')
SA_CUSTOMER_DS.write.saveAsTable(SEQ_ACCT_ADDRESS_LINK)
...
spark.sql('drop table if exists SEQ_BUDGET_LINE_ITEM_MASTER')
SA_CUSTOMER_DS.write.saveAsTable(SEQ_BUDGET_LINE_ITEM_MASTER)
...
spark.sql('drop table if exists SEQ_ARRANGEMENT_SETUP_MASTER')
SA_CUSTOMER_DS.write.saveAsTable(SEQ_ARRANGEMENT_SETUP_MASTER)
...
spark.sql('drop table if exists SEQ_ARRANGEMENT_MEMBER_LINK')
SA_CUSTOMER_DS.write.saveAsTable(SEQ_ARRANGEMENT_MEMBER_LINK)
...
spark.sql('drop table if exists SEQ_ARRANGEMENT_MEMBER_MIRROR')
SA_CUSTOMER_DS.write.saveAsTable(SEQ_ARRANGEMENT_MEMBER_MIRROR)
...
LINK_OUT_CONV10 = DATA_IN_CONV11.select(
	...
	DATA_IN.LOAN_FUND_PENDING_DRAW_AMOUNT.alias('LOAN_FUND_PENDING_DRAW_AMOUNT'),
...
spark.sql('drop table if exists SEQ_ACCT_FACILITY_REL_DTLS')
SA_CUSTOMER_DS.write.saveAsTable(SEQ_ACCT_FACILITY_REL_DTLS)
...
spark.sql('drop table if exists ACCT_ADDRESS_LINK_aud')
SA_CUSTOMER_DS.write.saveAsTable(ACCT_ADDRESS_LINK_aud)
...
spark.sql('drop table if exists ARRANGEMENT_MEMBER_LINK_aud')
SA_CUSTOMER_DS.write.saveAsTable(ARRANGEMENT_MEMBER_LINK_aud)
...
spark.sql('drop table if exists ARRANGEMENT_LINK_ENQUIRY_aud')
SA_CUSTOMER_DS.write.saveAsTable(ARRANGEMENT_LINK_ENQUIRY_aud)
...
spark.sql('drop table if exists SEQ_ARRANGEMENT_ACCT_LINK')
SA_CUSTOMER_DS.write.saveAsTable(SEQ_ARRANGEMENT_ACCT_LINK)
...
spark.sql('drop table if exists ARRANGEMENT_PROD_LINK_aud')
SA_CUSTOMER_DS.write.saveAsTable(ARRANGEMENT_PROD_LINK_aud)
...
spark.sql('drop table if exists SEQ_ARRANGEMENT_LINK_ENQUIRY')
SA_CUSTOMER_DS.write.saveAsTable(SEQ_ARRANGEMENT_LINK_ENQUIRY)
...
spark.sql('drop table if exists SEQ_ARRANGEMENT_PROD_LINK')
SA_CUSTOMER_DS.write.saveAsTable(SEQ_ARRANGEMENT_PROD_LINK)
...
spark.sql('drop table if exists ARRANGEMENT_MEMBER_PROD_LINK_aud')
SA_CUSTOMER_DS.write.saveAsTable(ARRANGEMENT_MEMBER_PROD_LINK_aud)
...
spark.sql('drop table if exists ARRANGEMENT_ACCT_LINK_aud')
SA_CUSTOMER_DS.write.saveAsTable(ARRANGEMENT_ACCT_LINK_aud)
...
spark.sql('drop table if exists SEQ_BUDGET_SUMMARY_MASTER')
SA_CUSTOMER_DS.write.saveAsTable(SEQ_BUDGET_SUMMARY_MASTER)
...
spark.sql('drop table if exists ACCT_FACILITY_REL_DTLS_aud')
SA_CUSTOMER_DS.write.saveAsTable(ACCT_FACILITY_REL_DTLS_aud)
...
spark.sql('drop table if exists ARRANGEMENT_SETUP_MASTER_aud')
SA_CUSTOMER_DS.write.saveAsTable(ARRANGEMENT_SETUP_MASTER_aud)